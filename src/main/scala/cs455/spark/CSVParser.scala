...
//    joinedInput.show()
    ...
    val file = joinedInput.rdd.map(row => {
      ...
      builder.append("1:").append(row.get(2)).append(" ")
      builder.append("2:").append(row.get(3)).append(" ")
      builder.append("3:").append(row.get(4)).append(" ")
      builder.append("4:").append(row.get(5)).append(" ")
      builder.append("5:").append(row.get(6)).append(" ")
      builder.append("6:").append(row.get(7)).append(" ")
      builder.append("7:").append(row.get(8)).append(" ")
      builder.append("8:").append(row.get(9)).append(" ")
      builder.toString()
